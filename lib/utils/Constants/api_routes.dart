class Api {
  ...
  static const String cardPayment = baseUrl + "card-payment";

  static const String payWithWallet = baseUrl + "pay-with-wallet";
  ...
  static const String varifyPhone = baseUrl + "verify-phone";
  ...
  static const String getAllGateKeeper = baseUrl + "getgatekeepers";

  static const String societySupport = baseUrl + "subadmin";
  static const String getVisitorDetails = baseUrl + "getVisitors";
  static const String updateUser = baseUrl + "update-user";

  static const String updatephone = baseUrl + "update-phone";
  static const String getAllPreApprovedEntry = baseUrl + "get-all-enteries";
