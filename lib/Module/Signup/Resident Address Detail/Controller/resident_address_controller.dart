...
class ResidentAddressDetailController extends GetxController {
  ...
  SelectedSociety(val) async {
    ...
    // Data _society = Data(
    //   id: societies?.id,
    //   country: societies?.country,
    //   state: societies?.state,
    //   city: societies?.city,
    //   type: societies?.type,
    //   name: societies?.name,
    //   slogan: societies?.slogan,
    //   address: societies?.address,
    //   logo: societies?.logo,
    //   hasCustomIntro: societies?.hasCustomIntro,
    //   structuretype: societies?.structureType,
    // );

    // await MySharedPreferences.setSocietyData(society: _society);
    update();
  }
  ...
  Future<List<Society>> viewAllSocietiesApi(String type, String token) async {
    ...
    societyli = (data as List)
        .map((e) => Society(
              ...
              slogan: e['slogan'],
              logo: e['logo'],
              hasCustomIntro: e['has_custom_intro'],
            ))
        .toList();
