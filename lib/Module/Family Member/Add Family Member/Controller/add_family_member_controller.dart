...
import 'package:userapp/Module/Verification/Verification%20Code/View/verification_code_for_family_member.dart';
...
class AddFamilyMemberController extends GetxController {
  ...
  Future addFamilyMemberApi(
    ...
    if (response.statusCode == 200) {
      ...
      Get.to(
          () => VerificationCodeForFamilyMenber(
                family_memberId: data['data']['family_member']
                    ['familymemberid'],
              ),
